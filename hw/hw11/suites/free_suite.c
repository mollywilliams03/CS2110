...
void setup_free_no_merge1(void) {
    ...
    unsigned long *tail_canary = (unsigned long *)((uint8_t *)meta + meta->size - sizeof (unsigned long) + TOTAL_METADATA_SIZE);
    meta->canary = ((uintptr_t)meta ^ CANARY_MAGIC_NUMBER) + 1890;
    *tail_canary = ((uintptr_t)meta ^ CANARY_MAGIC_NUMBER) + 1890;
...
void setup_free_right_merge1(void) {
    ...
    meta->size = 512 - TOTAL_METADATA_SIZE;
    unsigned long *tail_canary = (unsigned long *)((uint8_t *)meta + meta->size - sizeof (unsigned long) + TOTAL_METADATA_SIZE);
    meta->canary = *tail_canary = ((uintptr_t)meta ^ CANARY_MAGIC_NUMBER) + 1890;
...
START_TEST(test_free_double_merge1_insert) {
    ck_assert_int_eq(my_malloc_errno, NO_ERROR);
    ck_assert_int_eq(A -> size, b_size + 96 + a_size + 2 * TOTAL_METADATA_SIZE);
    ck_ptr(A, prev_a);
}
END_TEST
...
void setup_free_double_decker(void) {
    ...
    meta->size = 96;
    tail_canary = (unsigned long *)((uint8_t *)meta + meta->size - sizeof (unsigned long) + TOTAL_METADATA_SIZE);
    meta->canary = *tail_canary = ((uintptr_t)meta ^ CANARY_MAGIC_NUMBER) + 1890;
